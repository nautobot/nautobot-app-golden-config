...
- `python_ver`: the version of Python to use as a base for any built docker containers (default: 3.13)
...
#14 naming to docker.io/nautobot-golden-config/nautobot:2.4.2-py3.13 done
```
...
ee90fbfabd77   nautobot-golden-config/nautobot:2.4.2-py3.13  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_golden_config_worker_1
b8adb781d013   nautobot-golden-config/nautobot:2.4.2-py3.13  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_golden_config_nautobot_1
d64ebd60675d   nautobot-golden-config/nautobot:2.4.2-py3.13  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_golden_config_docs_1
