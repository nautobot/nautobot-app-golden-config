...
Starting in Nautobot v2.4.2, this UI also allows you to supply a `branch` parameter to specify the branch of the Jinja2 templates Git repository to use when rendering the configuration.
