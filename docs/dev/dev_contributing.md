...
- PRs intended to add new features should be sourced from the next branch.
- PRs intended to add new features that break backward compatibility should be discussed before a PR is created.
- PRs intended to address bug fixes and security patches should be sourced from develop.
