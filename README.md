...
5. **Configuration to Push** - (beta) Is a process to render a valid configuration artifact, from intended configuration, to push to devices. Current implementation only renders this configuration, and **it doesn't automatically push** to the target device.
