...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(blank=True, limit_choices_to={'provided_contents__contains': 'nautobot_golden_config.jinjatemplate'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jinja_template', to='extras.gitrepository'),
        ),
    ]
